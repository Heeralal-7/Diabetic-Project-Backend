// controllers/adminAboutUsController.js
        ...
        cards: [
          {
            ...
            description: "At our medical center, we believe in providing not just better care but a better experience overall. We understand that your journey to health.",
...
const updateAboutUs = async (req, res) => {
  try {
    ...
    if (files) {
      ...
      // Handle card images - this requires special logic based on your frontend implementation
      if (files.cardImages && updateData.cards && Array.isArray(updateData.cards)) {
        // You need to map cardImages to specific cards based on your frontend logic
        // This is a basic implementation - you might need to adjust it
