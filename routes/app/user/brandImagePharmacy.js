...
const fs = require('fs');
const brandController = require('../../../controllers/app/user/brandImagePharmacy');
const { adminMiddleware, middlewere } = require('../../../middleware/auth');
...
// Get all brands
router.get('/get-all', adminMiddleware,brandController.getBrands);
router.get('/get-all-data', middlewere,brandController.getBrands);
 
// Get single brand by ID
router.get('/get/:id', adminMiddleware,brandController.getBrandById);
...
// Delete brand
router.delete('/delete/:id',adminMiddleware, brandController.deleteBrand);
