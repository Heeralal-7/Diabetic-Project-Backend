...
const { getFoodOrder, changeOrderStatus, getOrder, orderHistory,getAcceptedOrders, assignDriverToOrder, getOrderWithDriver } = require('../../../../controllers/app/vandor/food/order')
...
route.post('/assign-driver/:id',VendorMiddleware,assignDriverToOrder)
