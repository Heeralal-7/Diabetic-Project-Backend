...
const { uploadMedicineExcel, getAllMedicineData,getPendingMedicines,
    approveMedicine,
    rejectMedicine,
    updateMedicine, deleteMedicine , deleteMultipleMedicine } = require("../../../../controllers/admin/Vendor/Pharmacy/Medicine");
...
router.delete("/delete-multiple-medicine", adminMiddleware, deleteMultipleMedicine);
